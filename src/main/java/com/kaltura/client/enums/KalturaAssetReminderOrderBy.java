 ...
 */
public enum KalturaAssetReminderOrderBy implements KalturaEnumAsString {
    ...
    KalturaAssetReminderOrderBy(String hashCode) {
    ...
    public static KalturaAssetReminderOrderBy get(String hashCode) {
