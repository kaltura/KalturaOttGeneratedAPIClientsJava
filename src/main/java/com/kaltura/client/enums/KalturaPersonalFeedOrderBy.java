 ...
 */
public enum KalturaPersonalFeedOrderBy implements KalturaEnumAsString {
    ...
    KalturaPersonalFeedOrderBy(String hashCode) {
    ...
    public static KalturaPersonalFeedOrderBy get(String hashCode) {
