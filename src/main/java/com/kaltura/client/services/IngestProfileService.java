...
public class IngestProfileService {
	...
	public static class AddIngestProfileBuilder extends RequestBuilder<IngestProfile, IngestProfile.Tokenizer, AddIngestProfileBuilder> {
		...
		public AddIngestProfileBuilder(IngestProfile ingestProfile) {
			super(IngestProfile.class, "ingestprofile", "add");
			params.add("ingestProfile", ingestProfile);
		}
	}
	 ...
	 * 
	 * @param ingestProfile ingest profile Object to be added
	 */
	...
	public static class DeleteIngestProfileBuilder extends RequestBuilder<Boolean, String, DeleteIngestProfileBuilder> {
		...
		public DeleteIngestProfileBuilder(int ingestProfileId) {
			super(Boolean.class, "ingestprofile", "delete");
			params.add("ingestProfileId", ingestProfileId);
		}
		
		public void ingestProfileId(String multirequestToken) {
			params.add("ingestProfileId", multirequestToken);
		}
	}
	 ...
	 * 
	 * @param ingestProfileId ingest profile Identifier
	 */
    public static DeleteIngestProfileBuilder delete(int ingestProfileId)  {
		return new DeleteIngestProfileBuilder(ingestProfileId);
	}
	...
	public static class UpdateIngestProfileBuilder extends RequestBuilder<IngestProfile, IngestProfile.Tokenizer, UpdateIngestProfileBuilder> {
		...
		public UpdateIngestProfileBuilder(int ingestProfileId, IngestProfile ingestProfile) {
	 ...
	 * 
	 * @param ingestProfileId ingest profile Identifier
	 * @param ingestProfile ingest profile Object
	 */
    public static UpdateIngestProfileBuilder update(int ingestProfileId, IngestProfile ingestProfile)  {
		return new UpdateIngestProfileBuilder(ingestProfileId, ingestProfile);
	}
}
