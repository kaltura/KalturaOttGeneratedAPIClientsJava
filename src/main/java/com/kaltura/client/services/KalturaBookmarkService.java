...
public class KalturaBookmarkService extends KalturaServiceBase {
    public KalturaBookmarkService(KalturaClient client) {
    ...
    public boolean add(KalturaBookmark bookmark) throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        kparams.add("bookmark", bookmark);
        this.kalturaClient.queueServiceCall("bookmark", "add", kparams);
    ...
    public KalturaBookmarkListResponse list(KalturaBookmarkFilter filter) throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        kparams.add("filter", filter);
        this.kalturaClient.queueServiceCall("bookmark", "list", kparams, KalturaBookmarkListResponse.class);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        return ParseUtils.parseObject(KalturaBookmarkListResponse.class, resultXmlElement);
    }
}
