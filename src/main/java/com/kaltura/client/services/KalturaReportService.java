...
public class KalturaReportService extends KalturaServiceBase {
    ...
    public KalturaReport get(String udid) throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        kparams.add("udid", udid);
        this.kalturaClient.queueServiceCall("report", "get", kparams, KalturaReport.class);
    ...
    public KalturaReportListResponse list(KalturaReportFilter filter, KalturaFilterPager pager) throws KalturaApiException {
        ...
        this.kalturaClient.queueServiceCall("report", "list", kparams, KalturaReportListResponse.class);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
