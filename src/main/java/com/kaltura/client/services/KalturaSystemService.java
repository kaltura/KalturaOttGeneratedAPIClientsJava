...
public class KalturaSystemService extends KalturaServiceBase {
    ...
    public long getTime() throws KalturaApiException {
    ...
    public String getVersion() throws KalturaApiException {
        KalturaParams kparams = new KalturaParams();
        this.kalturaClient.queueServiceCall("system", "getVersion", kparams);
        if (this.kalturaClient.isMultiRequest())
            return null;
        Element resultXmlElement = this.kalturaClient.doQueue();
        String resultText = resultXmlElement.getTextContent();
