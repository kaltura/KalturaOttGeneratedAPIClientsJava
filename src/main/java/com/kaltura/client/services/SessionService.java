...
public class SessionService {
	...
	public static class CreateSessionCharacteristicSessionBuilder extends RequestBuilder<SessionCharacteristic, SessionCharacteristic.Tokenizer, CreateSessionCharacteristicSessionBuilder> {
		...
		public CreateSessionCharacteristicSessionBuilder(String userId, int householdId, String udid, long expiration, int regionId, Map<String, StringValueArray> sessionCharacteristicParams) {
	...
	public static CreateSessionCharacteristicSessionBuilder createSessionCharacteristic(String userId, int householdId, String udid, long expiration)  {
		return createSessionCharacteristic(userId, householdId, udid, expiration, Integer.MIN_VALUE);
	}

	public static CreateSessionCharacteristicSessionBuilder createSessionCharacteristic(String userId, int householdId, String udid, long expiration, int regionId)  {
	 ...
	 */
    public static CreateSessionCharacteristicSessionBuilder createSessionCharacteristic(String userId, int householdId, String udid, long expiration, int regionId, Map<String, StringValueArray> sessionCharacteristicParams)  {
