...
@MultiRequestBuilder.Tokenizer(AssetEvent.Tokenizer.class)
public class AssetEvent extends EventObject {
	...
	public AssetEvent(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaAssetEvent");
		return kparams;
	}
