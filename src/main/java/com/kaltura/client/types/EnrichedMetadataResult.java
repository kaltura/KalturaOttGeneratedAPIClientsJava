...
/**
 * An object representing the newly generated metadata. It is used when a user
  requests to retrieve the results of the metadata enrichment.
 */
@SuppressWarnings("serial")
@MultiRequestBuilder.Tokenizer(EnrichedMetadataResult.Tokenizer.class)
public class EnrichedMetadataResult extends ObjectBase {
	 ...
	 * A dictionary holding the names and values of the generated metadata.            
	   key - the metadata name/key, e.g. ‘Genre’, ‘shortDescription’ etc.     
	          value - The metadata value generated by the LLM, in a
	  KalturaTranslationToken format.
	 */
	...
	public EnrichedMetadataResult() {
		super();
	}

	public EnrichedMetadataResult(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaEnrichedMetadataResult");
