...
@MultiRequestBuilder.Tokenizer(EpgFilter.Tokenizer.class)
public class EpgFilter extends Filter {
	...
	// dateEqual:
	public Long getDateEqual(){
		return this.dateEqual;
	}
	public void setDateEqual(Long dateEqual){
		this.dateEqual = dateEqual;
	}

	public void dateEqual(String multirequestToken){
		setToken("dateEqual", multirequestToken);
	}
	...
	public EpgFilter(JsonObject jsonObject) throws APIException {
		super(jsonObject);

		if(jsonObject == null) return;

		// set members values:
		dateEqual = GsonParser.parseLong(jsonObject.get("dateEqual"));
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaEpgFilter");
		kparams.add("dateEqual", this.dateEqual);
