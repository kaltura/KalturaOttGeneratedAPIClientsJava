...
public class KalturaApiActionPermissionItem extends KalturaPermissionItem {
	/**  API service name  */
    ...
    public KalturaApiActionPermissionItem(Element node) throws KalturaApiException {
        super(node);
