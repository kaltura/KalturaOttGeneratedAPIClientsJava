...
public class KalturaAssetComment extends KalturaSocialComment {
	/**  Comment ID  */
    ...
    public KalturaAssetComment() {
    }

    public KalturaAssetComment(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                continue;
            } else if (nodeName.equals("subHeader")) {
                this.subHeader = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
