...
public class KalturaAssetCommentFilter extends KalturaFilter {
	/**  Asset Id  */
    public int assetIdEqual = Integer.MIN_VALUE;
	/**  Asset Type  */
    public KalturaAssetType assetTypeEqual;

    public KalturaAssetCommentFilter() {
    }

    public KalturaAssetCommentFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("assetIdEqual")) {
                this.assetIdEqual = ParseUtils.parseInt(txt);
                continue;
