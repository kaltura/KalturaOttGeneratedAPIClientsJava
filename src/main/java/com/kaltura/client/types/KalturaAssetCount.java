...
public class KalturaAssetCount extends KalturaObjectBase {
	/**  Value  */
    public String value;
	/**  Count  */
    public int count = Integer.MIN_VALUE;
	/**  Sub groups  */
    public ArrayList<KalturaAssetsCount> subs;

    public KalturaAssetCount() {
    }

    public KalturaAssetCount(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("value")) {
                ...
                continue;
            } else if (nodeName.equals("subs")) {
                this.subs = ParseUtils.parseArray(KalturaAssetsCount.class, aNode);
                continue;
            } 
        }
    }
