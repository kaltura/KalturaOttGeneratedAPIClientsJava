...
public class KalturaAssetHistory extends KalturaObjectBase {
	/**  Asset identifier  */
    ...
    public long watchedDate = Long.MIN_VALUE;
	/**  Boolean which specifies whether the user finished watching the movie or not  */
    public boolean finishedWatching;

    public KalturaAssetHistory() {
    }

    public KalturaAssetHistory(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("assetId")) {
                ...
                continue;
            } else if (nodeName.equals("watchedDate")) {
                this.watchedDate = ParseUtils.parseBigint(txt);
                continue;
