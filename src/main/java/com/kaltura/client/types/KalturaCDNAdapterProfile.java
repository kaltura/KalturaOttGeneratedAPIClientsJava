...
public class KalturaCDNAdapterProfile extends KalturaObjectBase {
    ...
    public KalturaCDNAdapterProfile() {
    }

    public KalturaCDNAdapterProfile(Element node) throws KalturaApiException {
        super(node);
