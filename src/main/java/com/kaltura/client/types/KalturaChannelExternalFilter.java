...
public class KalturaChannelExternalFilter extends KalturaAssetFilter {
	...
	/**  UtcOffsetEqual  */
    public double utcOffsetEqual = Double.MIN_VALUE;
	/**  FreeTextEqual  */
    ...
    public KalturaChannelExternalFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("idEqual")) {
                ...
                this.utcOffsetEqual = ParseUtils.parseDouble(txt);
                continue;
