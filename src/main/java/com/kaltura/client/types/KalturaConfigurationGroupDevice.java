...
public class KalturaConfigurationGroupDevice extends KalturaObjectBase {
    ...
    public KalturaConfigurationGroupDevice() {
    }

    public KalturaConfigurationGroupDevice(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("configurationGroupId")) {
