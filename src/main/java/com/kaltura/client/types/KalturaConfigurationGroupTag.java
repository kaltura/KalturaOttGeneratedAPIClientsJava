...
public class KalturaConfigurationGroupTag extends KalturaObjectBase {
    ...
    public KalturaConfigurationGroupTag(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("configurationGroupId")) {
                ...
                this.tag = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
