...
public class KalturaCurrency extends KalturaObjectBase {
	/**  Currency name  */
    public String name;
	/**  Currency code  */
    public String code;
    ...
    public KalturaCurrency() {
    }

    public KalturaCurrency(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("name")) {
                ...
                this.sign = ParseUtils.parseString(txt);
                continue;
