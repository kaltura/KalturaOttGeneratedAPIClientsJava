...
public class KalturaEngagementAdapter extends KalturaEngagementAdapterBase {
    ...
    public HashMap<String, KalturaStringValue> engagementAdapterSettings;
	/**  Shared Secret  */
    public String sharedSecret;

    public KalturaEngagementAdapter() {
    }

    public KalturaEngagementAdapter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("isActive")) {
                ...
                continue;
            } else if (nodeName.equals("providerUrl")) {
                this.providerUrl = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("engagementAdapterSettings")) {
                this.engagementAdapterSettings = ParseUtils.parseMap(KalturaStringValue.class, aNode);
                continue;
