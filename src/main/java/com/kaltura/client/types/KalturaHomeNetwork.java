...
public class KalturaHomeNetwork extends KalturaObjectBase {
    ...
    public KalturaHomeNetwork() {
    }

    public KalturaHomeNetwork(Element node) throws KalturaApiException {
        super(node);
