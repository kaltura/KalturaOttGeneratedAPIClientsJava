...
public class KalturaHouseholdDeviceFamilyLimitations extends KalturaDeviceFamilyBase {
	/**  Allowed device change frequency code  */
    public int frequency = Integer.MIN_VALUE;
    ...
    public KalturaHouseholdDeviceFamilyLimitations() {
    }

    public KalturaHouseholdDeviceFamilyLimitations(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("frequency")) {
                this.frequency = ParseUtils.parseInt(txt);
                continue;
