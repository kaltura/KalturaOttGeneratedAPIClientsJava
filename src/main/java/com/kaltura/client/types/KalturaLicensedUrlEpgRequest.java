...
import com.kaltura.client.enums.KalturaStreamType;
...
public class KalturaLicensedUrlEpgRequest extends KalturaLicensedUrlMediaRequest {
    ...
    public KalturaStreamType streamType;
	/**  The start date of the stream (epoch)  */
    public long startDate = Long.MIN_VALUE;

    public KalturaLicensedUrlEpgRequest() {
    }

    public KalturaLicensedUrlEpgRequest(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("streamType")) {
                this.streamType = KalturaStreamType.get(ParseUtils.parseString(txt));
                continue;
