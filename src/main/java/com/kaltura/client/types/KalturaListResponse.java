...
public class KalturaListResponse extends KalturaObjectBase {
	/**  Total items  */
    public int totalCount = Integer.MIN_VALUE;

    public KalturaListResponse() {
    }

    public KalturaListResponse(Element node) throws KalturaApiException {
        super(node);
