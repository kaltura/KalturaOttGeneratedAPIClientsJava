...
public class KalturaMetaFilter extends KalturaFilter {
	/**  Meta system field name to filter by  */
    public KalturaMetaFieldName fieldNameEqual;
	/**  Meta system field name to filter by  */
    public KalturaMetaFieldName fieldNameNotEqual;
    ...
    public KalturaMetaFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("fieldNameEqual")) {
                this.fieldNameEqual = KalturaMetaFieldName.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("fieldNameNotEqual")) {
                this.fieldNameNotEqual = KalturaMetaFieldName.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("typeEqual")) {
                this.typeEqual = KalturaMetaType.get(ParseUtils.parseString(txt));
                continue;
