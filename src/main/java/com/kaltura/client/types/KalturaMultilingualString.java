...
public class KalturaMultilingualString extends KalturaObjectBase {
    ...
    public ArrayList<KalturaTranslationToken> values;

    public KalturaMultilingualString() {
    }

    public KalturaMultilingualString(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("values")) {
                this.values = ParseUtils.parseArray(KalturaTranslationToken.class, aNode);
                continue;
            } 
        }
    }
