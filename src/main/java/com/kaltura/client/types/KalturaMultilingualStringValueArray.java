...
public class KalturaMultilingualStringValueArray extends KalturaObjectBase {
    ...
    public ArrayList<KalturaMultilingualStringValue> objects;

    public KalturaMultilingualStringValueArray() {
    }

    public KalturaMultilingualStringValueArray(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("objects")) {
                this.objects = ParseUtils.parseArray(KalturaMultilingualStringValue.class, aNode);
                continue;
            } 
        }
    }
