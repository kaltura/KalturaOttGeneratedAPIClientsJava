...
public class KalturaNotificationsSettings extends KalturaObjectBase {
    ...
    public boolean pushFollowEnabled;

    public KalturaNotificationsSettings() {
    }

    public KalturaNotificationsSettings(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("pushNotificationEnabled")) {
                ...
                continue;
            } else if (nodeName.equals("pushFollowEnabled")) {
                this.pushFollowEnabled = ParseUtils.parseBool(txt);
                continue;
            } 
        }
    }
