...
public class KalturaOTTUserFilter extends KalturaFilter {
    ...
    public KalturaOTTUserFilter() {
    }

    public KalturaOTTUserFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("usernameEqual")) {
                this.usernameEqual = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("externalIdEqual")) {
                this.externalIdEqual = ParseUtils.parseString(txt);
                continue;
