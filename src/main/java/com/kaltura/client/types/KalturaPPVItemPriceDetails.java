...
import com.kaltura.client.enums.KalturaPurchaseStatus;
...
public class KalturaPPVItemPriceDetails extends KalturaObjectBase {
    ...
    public KalturaPurchaseStatus purchaseStatus;
    ...
    public KalturaPPVItemPriceDetails() {
    }

    public KalturaPPVItemPriceDetails(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("ppvModuleId")) {
                ...
                continue;
            } else if (nodeName.equals("purchaseStatus")) {
                this.purchaseStatus = KalturaPurchaseStatus.get(ParseUtils.parseString(txt));
                continue;
