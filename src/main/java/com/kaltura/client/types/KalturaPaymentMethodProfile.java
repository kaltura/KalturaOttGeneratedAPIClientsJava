...
public class KalturaPaymentMethodProfile extends KalturaObjectBase {
    ...
    public KalturaPaymentMethodProfile() {
    }

    public KalturaPaymentMethodProfile(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                continue;
            } else if (nodeName.equals("allowMultiInstance")) {
                this.allowMultiInstance = ParseUtils.parseBool(txt);
                continue;
            } 
        }
    }
