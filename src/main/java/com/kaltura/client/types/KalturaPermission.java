...
public class KalturaPermission extends KalturaObjectBase {
    ...
    public ArrayList<KalturaPermissionItem> permissionItems;
    ...
    public KalturaPermission(Element node) throws KalturaApiException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                continue;
            } else if (nodeName.equals("permissionItems")) {
                this.permissionItems = ParseUtils.parseArray(KalturaPermissionItem.class, aNode);
                continue;
            } 
        }
    }
