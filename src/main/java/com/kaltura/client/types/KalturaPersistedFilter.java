...
public abstract class KalturaPersistedFilter extends KalturaFilter {
    ...
    public KalturaPersistedFilter() {
    }

    public KalturaPersistedFilter(Element node) throws KalturaApiException {
        super(node);
