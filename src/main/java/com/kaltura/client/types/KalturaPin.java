...
import com.kaltura.client.enums.KalturaPinType;
...
public class KalturaPin extends KalturaObjectBase {
	/**  PIN code  */
    public String pin;
    ...
    public KalturaPin(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("pin")) {
                this.pin = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("origin")) {
                this.origin = KalturaRuleLevel.get(ParseUtils.parseString(txt));
                continue;
            } else if (nodeName.equals("type")) {
                this.type = KalturaPinType.get(ParseUtils.parseString(txt));
                continue;
            } 
        }
    }
