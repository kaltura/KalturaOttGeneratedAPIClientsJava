...
public class KalturaPpvEntitlement extends KalturaEntitlement {
    ...
    public int mediaFileId = Integer.MIN_VALUE;
	/**  Media identifier  */
    public int mediaId = Integer.MIN_VALUE;

    public KalturaPpvEntitlement() {
    }

    public KalturaPpvEntitlement(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("mediaFileId")) {
                this.mediaFileId = ParseUtils.parseInt(txt);
                continue;
