...
public class KalturaPreviewModule extends KalturaObjectBase {
    ...
    public int lifeCycle = Integer.MIN_VALUE;
	/**  The time you can&amp;#39;t buy the item to which the preview module is assigned
	  to again  */
    public int nonRenewablePeriod = Integer.MIN_VALUE;

    public KalturaPreviewModule() {
    }

    public KalturaPreviewModule(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                continue;
            } else if (nodeName.equals("lifeCycle")) {
                this.lifeCycle = ParseUtils.parseInt(txt);
                continue;
            } else if (nodeName.equals("nonRenewablePeriod")) {
                this.nonRenewablePeriod = ParseUtils.parseInt(txt);
                continue;
            } 
        }
    }
