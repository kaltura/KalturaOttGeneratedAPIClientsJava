...
public class KalturaProductCode extends KalturaObjectBase {
    ...
    public KalturaProductCode() {
    }

    public KalturaProductCode(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("inappProvider")) {
                this.inappProvider = ParseUtils.parseString(txt);
                continue;
