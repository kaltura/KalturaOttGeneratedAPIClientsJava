...
public abstract class KalturaProductPrice extends KalturaObjectBase {
	/**  Product identifier  */
    ...
    public KalturaProductPrice() {
    }

    public KalturaProductPrice(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("productId")) {
                this.productId = ParseUtils.parseString(txt);
                continue;
