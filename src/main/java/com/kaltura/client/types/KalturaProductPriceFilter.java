...
public class KalturaProductPriceFilter extends KalturaFilter {
    ...
    public KalturaProductPriceFilter() {
    }

    public KalturaProductPriceFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("subscriptionIdIn")) {
                this.subscriptionIdIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("fileIdIn")) {
                this.fileIdIn = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("isLowest")) {
                this.isLowest = ParseUtils.parseBool(txt);
                continue;
            } else if (nodeName.equals("couponCodeEqual")) {
                this.couponCodeEqual = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
