...
import com.kaltura.client.enums.KalturaPurchaseSettingsType;
...
public class KalturaPurchaseSettings extends KalturaPin {
    ...
    public KalturaPurchaseSettings() {
    }

    public KalturaPurchaseSettings(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("permission")) {
                this.permission = KalturaPurchaseSettingsType.get(ParseUtils.parseString(txt));
                continue;
            } 
        }
    }
