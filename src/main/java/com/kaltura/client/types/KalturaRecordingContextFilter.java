...
public class KalturaRecordingContextFilter extends KalturaFilter {
	/**  Comma separated asset ids  */
    public String assetIdIn;

    public KalturaRecordingContextFilter() {
    }

    public KalturaRecordingContextFilter(Element node) throws KalturaApiException {
        super(node);
