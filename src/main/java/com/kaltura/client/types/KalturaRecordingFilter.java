...
public class KalturaRecordingFilter extends KalturaFilter {
	/**  Recording Statuses  */
    public String statusIn;
	/**  KSQL expression  */
    public String filterExpression;

    public KalturaRecordingFilter() {
    }

    public KalturaRecordingFilter(Element node) throws KalturaApiException {
        super(node);
