...
public class KalturaRegionFilter extends KalturaFilter {
	/**  List of comma separated regions external identifiers  */
    public String externalIdIn;

    public KalturaRegionFilter() {
    }

    public KalturaRegionFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("externalIdIn")) {
