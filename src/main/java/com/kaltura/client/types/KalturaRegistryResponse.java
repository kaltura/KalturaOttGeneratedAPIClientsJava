...
public class KalturaRegistryResponse extends KalturaObjectBase {
	/**  Announcement Id  */
    ...
    public KalturaRegistryResponse() {
    }

    public KalturaRegistryResponse(Element node) throws KalturaApiException {
        super(node);
