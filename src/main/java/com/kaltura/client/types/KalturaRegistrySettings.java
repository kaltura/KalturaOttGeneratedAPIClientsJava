...
public class KalturaRegistrySettings extends KalturaObjectBase {
	/**  Permission item identifier  */
    public String key;
	/**  Permission item name  */
    public String value;

    public KalturaRegistrySettings() {
    }

    public KalturaRegistrySettings(Element node) throws KalturaApiException {
        super(node);
