...
public class KalturaSearchExternalFilter extends KalturaAssetFilter {
	/**  Query  */
    public String query;
	/**  UtcOffsetEqual  */
    public int utcOffsetEqual = Integer.MIN_VALUE;
    ...
    public KalturaSearchExternalFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("query")) {
                this.query = ParseUtils.parseString(txt);
                continue;
            } else if (nodeName.equals("utcOffsetEqual")) {
                this.utcOffsetEqual = ParseUtils.parseInt(txt);
                continue;
