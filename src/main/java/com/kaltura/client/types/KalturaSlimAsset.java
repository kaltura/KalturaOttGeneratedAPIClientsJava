...
public class KalturaSlimAsset extends KalturaObjectBase {
	/**  Internal identifier of the asset  */
    public String id;
	/**  The type of the asset. Possible values: media, recording, epg  */
    public KalturaAssetType type;

    public KalturaSlimAsset() {
    }

    public KalturaSlimAsset(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("id")) {
                ...
                this.type = KalturaAssetType.get(ParseUtils.parseString(txt));
                continue;
            } 
        }
    }
