...
public class KalturaSocialActionFilter extends KalturaFilter {
    ...
    public KalturaSocialActionFilter() {
    }

    public KalturaSocialActionFilter(Element node) throws KalturaApiException {
        super(node);
