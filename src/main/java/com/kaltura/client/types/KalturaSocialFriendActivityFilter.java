...
public class KalturaSocialFriendActivityFilter extends KalturaFilter {
    ...
    public KalturaSocialFriendActivityFilter() {
    }

    public KalturaSocialFriendActivityFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("assetIdEqual")) {
                ...
                continue;
            } else if (nodeName.equals("actionTypeIn")) {
                this.actionTypeIn = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
