...
public class KalturaSubscriptionDependencySetFilter extends KalturaSubscriptionSetFilter {
    ...
    public KalturaSubscriptionDependencySetFilter() {
    }

    public KalturaSubscriptionDependencySetFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("baseSubscriptionIdIn")) {
                this.baseSubscriptionIdIn = ParseUtils.parseString(txt);
                continue;
            } 
        }
    }
