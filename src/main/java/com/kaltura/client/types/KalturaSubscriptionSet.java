...
public abstract class KalturaSubscriptionSet extends KalturaObjectBase {
    ...
    public KalturaSubscriptionSet() {
    }

    public KalturaSubscriptionSet(Element node) throws KalturaApiException {
        super(node);
