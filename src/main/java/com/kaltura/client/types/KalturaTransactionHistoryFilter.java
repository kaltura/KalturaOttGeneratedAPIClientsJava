...
public class KalturaTransactionHistoryFilter extends KalturaFilter {
    ...
    public KalturaTransactionHistoryFilter() {
    }

    public KalturaTransactionHistoryFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("entityReferenceEqual")) {
