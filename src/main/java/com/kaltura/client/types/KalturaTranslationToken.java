...
public class KalturaTranslationToken extends KalturaObjectBase {
	/**  Language code  */
    public String language;
	/**  Translated value  */
    public String value;

    public KalturaTranslationToken() {
    }

    public KalturaTranslationToken(Element node) throws KalturaApiException {
        super(node);
