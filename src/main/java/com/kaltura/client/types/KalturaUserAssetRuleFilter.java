...
public class KalturaUserAssetRuleFilter extends KalturaFilter {
    ...
    public int assetTypeEqual = Integer.MIN_VALUE;

    public KalturaUserAssetRuleFilter() {
    }

    public KalturaUserAssetRuleFilter(Element node) throws KalturaApiException {
        super(node);
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if (nodeName.equals("assetIdEqual")) {
                ...
                this.assetTypeEqual = ParseUtils.parseInt(txt);
                continue;
            } 
        }
    }
