...
@MultiRequestBuilder.Tokenizer(MetaEnrichConfiguration.Tokenizer.class)
public class MetaEnrichConfiguration extends ObjectBase {
	...
	public MetaEnrichConfiguration() {
		super();
	}

	public MetaEnrichConfiguration(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaMetaEnrichConfiguration");
