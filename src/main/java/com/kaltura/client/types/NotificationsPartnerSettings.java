...
public class NotificationsPartnerSettings extends ObjectBase {
	...
	// iotAdapterUrl:
	public String getIotAdapterUrl(){
		return this.iotAdapterUrl;
	}
	public void setIotAdapterUrl(String iotAdapterUrl){
		this.iotAdapterUrl = iotAdapterUrl;
	}

	public void iotAdapterUrl(String multirequestToken){
		setToken("iotAdapterUrl", multirequestToken);
	}
	...
	public NotificationsPartnerSettings(JsonObject jsonObject) throws APIException {
		...
		iotAdapterUrl = GsonParser.parseString(jsonObject.get("iotAdapterUrl"));
	...
	public Params toParams() {
		...
		kparams.add("iotAdapterUrl", this.iotAdapterUrl);
		return kparams;
	}
