...
public class Partner extends ObjectBase {
	...
	public void creatDate(String multirequestToken){
		setToken("creatDate", multirequestToken);
	}
	...
	public Partner(JsonObject jsonObject) throws APIException {
		...
		creatDate = GsonParser.parseLong(jsonObject.get("creatDate"));
	...
	public Params toParams() {
		...
		kparams.add("creatDate", this.creatDate);
