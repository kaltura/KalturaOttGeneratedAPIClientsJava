...
/**
 * If filter properties are empty will return all API argument type permission
  items
 */
@SuppressWarnings("serial")
@MultiRequestBuilder.Tokenizer(PermissionItemByArgumentFilter.Tokenizer.class)
public class PermissionItemByArgumentFilter extends PermissionItemByApiActionFilter {
	...
	public PermissionItemByArgumentFilter(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaPermissionItemByArgumentFilter");
