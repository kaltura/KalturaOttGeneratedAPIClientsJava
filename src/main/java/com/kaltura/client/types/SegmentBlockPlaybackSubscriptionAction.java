...
@MultiRequestBuilder.Tokenizer(SegmentBlockPlaybackSubscriptionAction.Tokenizer.class)
public class SegmentBlockPlaybackSubscriptionAction extends BlockSubscriptionSegmentAction {
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaSegmentBlockPlaybackSubscriptionAction");
		return kparams;
	}
