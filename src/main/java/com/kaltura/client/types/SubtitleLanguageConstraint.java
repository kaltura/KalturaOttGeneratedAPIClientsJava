...
@MultiRequestBuilder.Tokenizer(SubtitleLanguageConstraint.Tokenizer.class)
public class SubtitleLanguageConstraint extends BaseAttributeConstraint {
	...
	public SubtitleLanguageConstraint() {
		super();
	}

	public SubtitleLanguageConstraint(JsonObject jsonObject) throws APIException {
		super(jsonObject);
	...
	public Params toParams() {
		...
		kparams.add("objectType", "KalturaSubtitleLanguageConstraint");
