...
import com.kaltura.client.types.SeriesInfo;
...
public class WatchBasedRecommendationsProfile extends ObjectBase {
	...
	public interface Tokenizer extends ObjectBase.Tokenizer {
		...
		String recommendationsMediaTypeIds();
		SeriesInfo.Tokenizer recommendationsSeriesInfo();
	}
	...
	/**
	 * List of comma seperated media type ids that will be included in the
	  recommendations.
	 */
	private String recommendationsMediaTypeIds;
	/**
	 * Series info ror recommendations calculation
	 */
	private SeriesInfo recommendationsSeriesInfo;
	...
	// recommendationsMediaTypeIds:
	public String getRecommendationsMediaTypeIds(){
		return this.recommendationsMediaTypeIds;
	}
	public void setRecommendationsMediaTypeIds(String recommendationsMediaTypeIds){
		this.recommendationsMediaTypeIds = recommendationsMediaTypeIds;
	}

	public void recommendationsMediaTypeIds(String multirequestToken){
		setToken("recommendationsMediaTypeIds", multirequestToken);
	}

	// recommendationsSeriesInfo:
	public SeriesInfo getRecommendationsSeriesInfo(){
		return this.recommendationsSeriesInfo;
	}
	public void setRecommendationsSeriesInfo(SeriesInfo recommendationsSeriesInfo){
	...
	public WatchBasedRecommendationsProfile(JsonObject jsonObject) throws APIException {
		...
		recommendationsMediaTypeIds = GsonParser.parseString(jsonObject.get("recommendationsMediaTypeIds"));
		recommendationsSeriesInfo = GsonParser.parseObject(jsonObject.getAsJsonObject("recommendationsSeriesInfo"), SeriesInfo.class);
	...
	public Params toParams() {
		...
		kparams.add("recommendationsMediaTypeIds", this.recommendationsMediaTypeIds);
		kparams.add("recommendationsSeriesInfo", this.recommendationsSeriesInfo);
		return kparams;
	}
