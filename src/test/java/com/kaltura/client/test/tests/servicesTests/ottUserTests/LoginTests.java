...
//    @Issue("BEO-4933")
    ...
    private void login_with_wrong_username() {
        loginResponse = OttUserServiceImpl.login(client, PARTNER_ID, user.getUsername() + "1", password, null, null);
    ...
    private void login_with_wrong_partnerId() {
        loginResponse = OttUserServiceImpl.login(client, PARTNER_ID + 1, user.getUsername(), password, null, null);
