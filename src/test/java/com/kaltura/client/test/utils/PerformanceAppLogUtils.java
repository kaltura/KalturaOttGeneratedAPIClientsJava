...
//    }
//
//    private static final int maxAllowedPercentage = Integer.valueOf(getProperty(MAX_CODE_PERCENTAGE));
//    private static final String remoteSourceUrlFileDir = getProperty(LOGS_BASE_URL) + getProperty(API_VERSION) + "\\";
//
...
//                                    totalTime > Double.parseDouble(getProperty(MAX_EXECUTION_TIME_IN_SEC))) {
//                                slowRatio = methodsAndSlowRatioData.get(method);
//                                slowRatio.slowCount++;
//                                methodsAndSlowRatioData.put(method, slowRatio);
//
...
//            String reportFileName = getProperty(LOGS_DIR) +
//                    getProperty(PERFORMANCE_REPORT_FILE);
//            String summaryTemporaryFileName = getProperty(LOGS_DIR) + "SUMMARY" +
//                    getProperty(PERFORMANCE_REPORT_FILE);
//
...
//            out.println("Max allowed percentage: " + getProperty(MAX_CODE_PERCENTAGE));
//            out.println("Max allowed execution time in seconds: " + getProperty(MAX_EXECUTION_TIME_IN_SEC));
//            out.println();
...
//        try (FileWriter fw = new FileWriter(getProperty(LOGS_DIR) +
//                getProperty(PERFORMANCE_REPORT_FILE), true);
//             BufferedWriter bw = new BufferedWriter(fw);
//             PrintWriter out = new PrintWriter(bw)) {
...
//        File localTargetFolderPath = new File(getProperty(LOGS_DIR));
...
//                    getProperty(LOGS_DIR) + "] was created == [" + isDirCreated + "]");
//        }
//
//        String remoteFilePathUrl = remoteSourceUrlFileDir + remoteFileName;
//        String localTargetFilePath = getProperty(LOGS_DIR) + "copied-" + remoteFileName;
...
//
//    /**
//     * We have file with name getProperty(LOGS_DIR) + getProperty(REGRESSION_LOGS_FILE)
...
//     */
//    public static Map<String, List<String>> loadMethodsAndSessionsFromTestFile() {
//        Logger.getLogger(PerformanceAppLogUtils.class).debug("loadMethodsAndSessionsFromTestFile(): started");
//        Map<String, List<String>> result = new HashMap<>();
//        String[] values;
//        try {
//            InputStream is = new FileInputStream(getProperty(LOGS_DIR) +
//                    getProperty(REGRESSION_LOGS_FILE));
...
//        String path2File = getProperty(LOGS_DIR) + "copied-" + appFileName;
//
